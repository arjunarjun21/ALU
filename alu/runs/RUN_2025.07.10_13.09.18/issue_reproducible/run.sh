...
export FP_PDN_VOFFSET='3.160';
export FP_PDN_VPITCH='6.325';
...
export SAVE_DEF='./results/floorplan/alu.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./results/floorplan/alu.odb';
